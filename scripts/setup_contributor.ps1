...
Write-Host "  3. py scripts\pack_contribution.py shards\mine --handle your-github-name"
Write-Host "  4. Upload the bundle to any file host, then open a 'Shard contribution'"
Write-Host "     issue with the download link:"
